namespace CleanArchWorkerService.Infrastructure.Repositories.EfCore;
...
public class TodoItemRepository : ITodoItemRepository
{
    ...
    {
        return await _context.Items.Where(item => !item.IsComplete).ToListAsync(cancellationToken);
    }
}
